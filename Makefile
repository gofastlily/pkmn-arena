...
pkmnarena_obj       := $(rom_obj)
pkmnarena_debug_obj := $(rom_obj:.o=_debug.o)
pkmnarena_vc_obj    := $(rom_obj:.o=_vc.o)
...
all: $(roms)
yellow:       pkmnarena.gbc
yellow_debug: pkmnarena_debug.gbc
yellow_vc:    pkmnarena.patch
...
$(pkmnarena_debug_obj): RGBASMFLAGS += -D _DEBUG
$(pkmnarena_vc_obj):    RGBASMFLAGS += -D _YELLOW_VC
...
$(foreach obj, $(pkmnarena_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(pkmnarena_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(pkmnarena_vc_obj), $(eval $(call DEP,$(obj),$(obj:_vc.o=.asm))))
...
pkmnarena_pad       = 0x00
pkmnarena_debug_pad = 0xff
pkmnarena_vc_pad    = 0x00
